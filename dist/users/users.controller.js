...
__decorate([
    (0, roles_decorator_1.Roles)('default'),
    (0, common_1.UseGuards)((0, auth_guard_1.AuthGuard)('jwt'), role_guard_1.RoleGuard),
    (0, common_1.Get)('/checkwhats/:id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "verifyWhats", null);
__decorate([
    (0, roles_decorator_1.Roles)('default'),
    (0, common_1.UseGuards)((0, auth_guard_1.AuthGuard)('jwt'), role_guard_1.RoleGuard),
    (0, common_1.Patch)(':id'),
...
__decorate([
    (0, roles_decorator_1.Roles)('default'),
    (0, common_1.UseGuards)((0, auth_guard_1.AuthGuard)('jwt'), role_guard_1.RoleGuard),
    (0, common_1.Patch)('/revert/:id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "revert", null);
__decorate([
    (0, roles_decorator_1.Roles)('default'),
    (0, common_1.UseGuards)((0, auth_guard_1.AuthGuard)('jwt'), role_guard_1.RoleGuard),
