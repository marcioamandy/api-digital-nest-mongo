...
__decorate([
    (0, class_validator_1.IsNumber)({}, { message: 'O campo custo tem que ser um número' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'O campo custo não pode ser vazio' }),
    (0, class_transformer_1.Type)(() => mongoose_1.default.Types.Decimal128),
    __metadata("design:type", mongoose_1.default.Types.Decimal128)
], UpdateServiceDto.prototype, "cost", void 0);
